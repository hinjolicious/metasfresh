	...
	public void testProductionOrderEvent()
	{
		final PPOrderRequestedEvent event = PPOrderRequestedEvent.builder()
				...
				.ppOrder(PPOrder.builder()
						...
						.plantId(110)
						.productId(120)
						.asiKey("ppOrderAsiKey")
						.attributeSetInstanceId(125)
						...
						.line(PPOrderLine.builder()
								...
								.productId(290)
								.asiKey("ppOrderLine1AsiKey")
								.attributeSetInstanceId(295)
						...
						.line(PPOrderLine.builder()
								...
								.productId(390)
								.asiKey("ppOrderLine2AsiKey")
								.attributeSetInstanceId(395)
